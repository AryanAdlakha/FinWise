...
struct Recents: View {
                ...
                ScrollView(.vertical) {
                    LazyVStack(spacing: 10, pinnedViews: [.sectionHeaders]) {
                        Section {
                            ...
                            FilterTransactionsView(startDate: startDate, endDate: endDate, content: { transactions in
                                CardView(
                                    income: total(transactions, category: .income),
                                    expenses: total(transactions, category: .expenses),
                                   recurring: total(transactions, category: .recurring)
                                )
    ...
    func HeaderView(_ size: CGSize) -> some View {
        ...
        .background {
            ...
            .padding([.horizontal, .top], -(safeArea.top + 15))
        }
    }
